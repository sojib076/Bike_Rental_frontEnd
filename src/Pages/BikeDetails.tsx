...
const BikeDetails = () => {
  ...
  const useloader = useLoaderData() as any;
  const bike = useloader.data as BikeDetailsType
              ...
              <div className="order-1 ">
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    {
                      bike.isAvailable ? <Button size="lg">Rent Now</Button> : <Button size="lg" variant="outline">Notify me when available</Button>
                    }
